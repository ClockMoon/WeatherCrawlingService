      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              newWindow = window.open("http://localhost:8080/api/card", "newWindow");
              eventForm = e.target;
              window.location.href = "http://localhost:8080/api/card/excel"; // return await axios.get("http://localhost:8080/api/card");
...
//# sourceMappingURL=index.js.0214d5f22494f71abce1.hot-update.js.map